...
[source,bash]
----
$ tebako press -m runtime -o tebako-runtime -R {ruby-ver}
----
...
[source,sh]
----
$ tebako runtime --tebako-run tebako-application Maxim
----

. *Deploy the packages*

** Deploy the runtime package to shared location for download
